...
function main:Begin(PROPS) 
    ...
    warn("Edited by me to look a bit different, but still in a neat form, lol.");
    ...
    function ElementHandler:ColorPicker3(ColorPickerArgs) 
        ...
        Color_ElementBlue.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    ...
    function ElementHandler:RadioButtons(RadioButtonsArgs) 
        ...
        for i, radio in pairs(RadioButtonsArgs.Buttons) do 
            ...
            Radio_ElementItem.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            ...
            Radio_ElementItemButton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    ...
    function ElementHandler:SinWaveGraph(SinWaveGraphArgs) 
        ...
        SinWaveGraph_ElementDisplay.BackgroundColor3 = Color3.fromRGB(255, 255 255)
    ...
    function ElementHandler:BeginMenuBar() 
        ...
        MenuBar.BorderColor3 = Color3.fromRGB(255, 255, 255)
        ...
        function ElementHandler:BeginMenu(MenuName) 
            ...
            MenuBarItem.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            ...
            function ElementHandler:MenuItem(ItemProperties) 
                ...
                MenuBarItem_Items.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
